...
import 'package:driver_app/features/home/models/select_option_model.dart';
import 'package:driver_app/features/home/widgets/list_select.dart';
import 'package:driver_app/features/home/widgets/photo_of_recent.dart';
import 'package:driver_app/features/payment/widgets/received_money.dart';
import 'package:driver_app/features/payment/widgets/label_text_widgets.dart';
import 'package:driver_app/features/main/view/main_view.dart';
...
import 'package:driver_app/shared/widgets/custom-container.dart';
import 'package:driver_app/shared/widgets/snack_bar_top.dart';
...
class _ConfirmPaymentViewState extends State<ConfirmPaymentView> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: closeKeyboard,
      child: Scaffold(
        appBar: AppBarCustom(title: 'ConfirmPayment'),
            ...
            children: [
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    LabelTextPay(label: 'Total Payment'),
                    SizedBox(height: 10),
                    CustomContainer(
                      child: Row(
